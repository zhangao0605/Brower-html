    ...
    >
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="to_tr show_color_choose"@click="to_block_details(scope.row.chainId,scope.row.height,scope.row.hash)">{{scope.row.height}}</span>
        </template>
      </el-table-column>
      <el-table-column
...
<script>
  ...
  export default {
    ...
    created() {
      ...
      this.all_data = this.$store.getters.main_unchaincommittee
