  ...
  <div class="mc_con">
    ...
    >
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" v-show="is_zh==0" @click="to_fragmented_page(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==1" @click="to_fragmented_page(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==2" @click="to_fragmented_page(scope.row.chainId)">{{chainid_change_ja(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==3" @click="to_fragmented_page(scope.row.chainId)">{{chainid_change_ko(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    >
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" v-show="is_zh==0" @click="to_unfragmented_page(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==1" @click="to_unfragmented_page(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==2" @click="to_unfragmented_page(scope.row.chainId)">{{chainid_change_ja(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==3" @click="to_unfragmented_page(scope.row.chainId)">{{chainid_change_ko(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('table.block_height')"
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          <span class="to_tr show_color_choose"
                @click="to_block_detail_interface(scope.row.chainId,scope.row.height,scope.row.hash)">{{slice_hash(scope.row.hash)}}</span>
        </template>
      </el-table-column>
      <el-table-column
    ...
    >
      ...
      <el-table-column
        ...
        align="center">
        <template slot-scope="scope">
          <span class="to_tr show_color_choose" v-show="is_zh==0" @click="to_information_chain(scope.row.chainId)">{{chainid_change_zh(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==1" @click="to_information_chain(scope.row.chainId)">{{chainid_change_en(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==2" @click="to_information_chain(scope.row.chainId)">{{chainid_change_ja(scope.row.chainId)}}</span>
          <span class="to_tr show_color_choose" v-show="is_zh==3" @click="to_information_chain(scope.row.chainId)">{{chainid_change_ko(scope.row.chainId)}}</span>
        </template>
      </el-table-column>
      <el-table-column
        :label="$t('table.timestamp')"
