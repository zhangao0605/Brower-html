    ...
    <div class="ct_all">
      ...
      <div class="ct_all_con">
        ...
        <div class="ct_all_con_right ct_all_con_right_last" style="height: 150px;user-select: none" v-show="is_ha">
          ...
          <span
            @click="to_withdrawal_page(Number(all_data_connectedTx.txType),all_data_connectedTx.chainId,all_data_connectedTx.hash)"
...
<script>
  ...
  export default {
    ...
    methods: {
      go_search_tr() {
        let data = this.$store.getters.home_search_tr_6
