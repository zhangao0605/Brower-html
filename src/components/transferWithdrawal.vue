  ...
  <div class="ct_con">
    ...
    <div class="ct_all">
      ...
      <div class="ct_all_con">
        ...
        <div class="ct_all_con_right">
          <span v-show="is_zh==0">{{tr_change_zh(Number(all_data.txType))}}</span>
          <span v-show="is_zh==1">{{tr_change_en(Number(all_data.txType))}}</span>
          <span v-show="is_zh==2">{{tr_change_ja(Number(all_data.txType))}}</span>
          <span v-show="is_zh==3">{{tr_change_ko(Number(all_data.txType))}}</span>
        </div>
      </div>
      <div class="ct_all_con">
        <div class="ct_all_con_left ">
      ...
      <div class="ct_all_con">
        ...
        <div class="ct_all_con_right ct_all_con_right_last" style="height: 150px;user-select: none" v-show="is_ha">
          <span v-show="is_zh==0">{{tr_change_zh(Number(all_data_connectedTx.txType))}}</span>
          <span v-show="is_zh==1">{{tr_change_en(Number(all_data_connectedTx.txType))}}</span><br>
          <span v-show="is_zh==2">{{tr_change_ja(Number(all_data_connectedTx.txType))}}</span><br>
          <span v-show="is_zh==3">{{tr_change_ko(Number(all_data_connectedTx.txType))}}</span><br>
          <span class="to_tr color_choose"
                v-show="is_zh==0">{{chainid_change_zh(all_data_connectedTx.chainId)}}</span>
          <span class="to_tr color_choose"
                v-show="is_zh==1">{{chainid_change_en(all_data_connectedTx.chainId)}}</span><br>
          <span class="to_tr color_choose"
                v-show="is_zh==2">{{chainid_change_ja(all_data_connectedTx.chainId)}}</span><br>
          <span class="to_tr color_choose"
                v-show="is_zh==3">{{chainid_change_ko(all_data_connectedTx.chainId)}}</span><br>
          <span
